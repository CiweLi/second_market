<template>
  ...
  <div class="user-order" v-for="item in data.orderData">
    ...
    <div class="user-order-top">
      <div class="userinfo">
        <img :src="item.sellerAvatar" class="avatar">
    ...
    <div class="user-order-center">
      ...
      <div class="goods-wrap">
        ...
        <div class="info">
          ...
          <div class="btn-group">
            <el-button type="warning" round size="small" class="btn" @click="receive(item)" v-if="item.state=='已发货'">确认收货</el-button>
            <el-button type="success" round size="small" class="btn" @click="commentBtn(item)" v-if="item.state=='已完成'">评价</el-button>
    ...
    <el-dialog v-model="data.formVisible" title="订单详情" width="40%" destroy-on-close>
      <el-form :model="data.form" ref="formRef" :rules="data.rules"  class="form">
        ...
        <el-form-item label="卖家" label-width="80px"  >
          <el-input v-model="data.form.sellerName"/>
        </el-form-item>
...
const load=()=>{
  request.get('/order/selectPageByBuyer',{
    params:{
