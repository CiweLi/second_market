...
<div>
  <div class="top-card">
<el-card>
  <el-input class="search-input"  v-model="data.name" placeholder="请输入分类名称" :prefix-icon="Search" ></el-input>
  ...
  <el-dialog v-model="data.formVisible" name="分类信息" width="40%" destroy-on-close>
    <el-form :model="data.form" ref="formRef" :rules="data.rules"  class="form">
      <el-form-item label="类名" label-width="80px" prop="name" >
